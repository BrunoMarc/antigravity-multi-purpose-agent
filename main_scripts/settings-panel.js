...
class SettingsPanel {
    ...
    sendStats() {
        ...
        const frequency = this.context.globalState.get('auto-accept-frequency', 3000);
        ...
        <body>
                ...
                <div class="section" id="performanceSection">
                    ...
                    <div>
                        <div style="display: flex; gap: 12px; align-items: center; margin-bottom: 8px;">
                            ...
                            <div style="flex: 1;"><input type="range" id="freqSlider" min="200" max="60000" step="100" value="1000"></div>
                    ...
                    <div>
                        ...
                        <div id="scheduleControls" style="opacity: 0.5; pointer-events: none; transition: opacity 0.3s;">
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
                                ...
                                <div id="scheduleValueContainer">
                                    <label style="font-size: 11px; color: var(--fg-dim); display: block; margin-bottom: 4px;">Interval Value</label>
                            ...
                            <div id="queueModeSection" style="display: none;">
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
                                    ...
                                    <div>
                                        <label style="font-size: 11px; color: var(--fg-dim); display: block; margin-bottom: 4px;" title="Time to wait after the AI appears idle before sending the next prompt. Increase if the AI runs long terminal commands.">Idle Timeout (s)</label>
                                        <input type="number" id="silenceTimeout" value="30" min="10" max="600" style="width: 100%; background: rgba(255,255,255,0.04); border: 1px solid var(--border); color: var(--fg); padding: 10px 12px; border-radius: 10px;">
                                    </div>
                                </div>
                                ...
                                <div style="background: rgba(255,255,255,0.03); border-radius: 12px; padding: 14px; margin-bottom: 12px; border: 1px solid rgba(255,255,255,0.06);">
                                    <div style="margin-bottom: 8px;">
                                        <span style="font-size: 12px; display: block; margin-bottom: 4px;">Fallback Model (Auto-Switch)</span>
                                        <select id="fallbackModel" style="width: 100%; background: rgba(255,255,255,0.04); border: 1px solid var(--border); color: var(--fg); padding: 8px 10px; border-radius: 6px; font-size: 11px;">
                                            <option value="">Disabled (Wait for Quota)</option>
                                    ...
                                    <div style="font-size: 10px; color: var(--fg-dim);">
                                        If Claude quota is exhausted, the queue will automatically switch to this model and continue running.
                                    </div>
                                </div>
            ...
            <script>
                ...
                function updateModeVisibility() {
                    ...
                    if (scheduleValueContainer) scheduleValueContainer.style.display = mode === 'queue' ? 'none' : 'block';
                }
                ...
                if (startQueueBtn) {
                     startQueueBtn.addEventListener('click', (e) => {
                        ...
                        const schedule = {
                            ...
                            fallbackModel: document.getElementById('fallbackModel') ? document.getElementById('fallbackModel').value : ''
                        };
